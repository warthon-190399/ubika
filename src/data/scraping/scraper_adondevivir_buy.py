...
def scrapear_pagina(page_num):
    base_url = f"https://www.adondevivir.com/inmuebles-en-venta-pagina-{page_num}-q-lima.html"
    data = []
...
def main():
    ...
    adondevivir_path = os.path.join(file_location, "adondevivir_buy") # New folder
