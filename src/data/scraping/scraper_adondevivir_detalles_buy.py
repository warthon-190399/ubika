...
def main():
    ...
    csv_path = os.path.join(BASE_DIR, "data", "raw", "adondevivir_buy","adondevivir_todas_las_paginas_buy.csv")
    output_path = os.path.join(BASE_DIR, "data", "raw", "adondevivir_buy", "adondevivir_todo3_completo.csv")
    #
    # print(csv_path)
    # print(output_path)
    #
