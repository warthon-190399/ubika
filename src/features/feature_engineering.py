...
def main(folder_name):
    ...
    input_path = os.path.join(BASE_DIR, "data", "processed", folder_name, f"{folder_name}_data_preprocessing.csv")
    output_path = os.path.join(BASE_DIR, "data", "processed", folder_name, f"{folder_name}_data_preprocessing_eng.csv")
