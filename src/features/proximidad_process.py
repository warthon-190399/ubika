...
def main(folder_name):
    ...
    input_path_adondevivir = os.path.join(BASE_DIR, "data", "processed", folder_name,f"{folder_name}_processed_geo.csv")
    ...
    output_path = os.path.join(BASE_DIR, "data", "processed", folder_name,f"{folder_name}_proximidad_processed.csv")
