...
def main(folder_name, target, features, test_size, random_state, n_trials, enabled_models):
    ...
    input_path = os.path.join(BASE_DIR, "data", "processed", folder_name,f"{folder_name}_dataset_h.csv")
    output_path = os.path.join(BASE_DIR, "data", "processed", folder_name,f"{folder_name}_final_dataset_h.csv")
    ...
    plt.savefig(
        os.path.join(BASE_DIR, "reports", "figures", folder_name, f"{folder_name}_corr_matrix_h.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
    ...
    df_resultados.to_csv(
        os.path.join(results_path, f"{folder_name}_model_results_h.csv"),
        index=False
    )
    ...
    plt.savefig(
        os.path.join(BASE_DIR, "reports", "figures", folder_name, f"{folder_name}_shap_summary_h.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
